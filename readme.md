...
By default, the local setup will pick the openapi specification located at https://project-ii.ti.howest.be/monitor/apis/group-11.
...
## Production endpoints
 - H2 web client
   - https://project-ii.ti.howest.be/db-11
   - url: jdbc:h2:./db-11
   - username:group-11
   - password:see Leho for details.
 - Useful information
   - Server logs
     - https://project-ii.ti.howest.be/monitor/logs/group-11
   - Swagger Interface
     - https://project-ii.ti.howest.be/monitor/swagger/group-11
 ...
 - Web client project
   - https://project-ii.ti.howest.be/mars-11
 - Sonar
   - https://sonar.ti.howest.be/dashboard?id=2022.project-ii%3Amars-server-11
   - https://sonar.ti.howest.be/dashboard?id=2022.project-ii%3Amars-client-11
